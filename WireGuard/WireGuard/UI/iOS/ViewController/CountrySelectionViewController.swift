...
//
//            manager.request(Constants.APIURLS.globalapiUrl+Constants.MethodName.countrylist, method: .get, parameters: nil, encoding:URLEncoding.default).responseJSON { response in
...
//                            let locationId = subJson["locationId"].stringValue
//                            // Access pivot dictionary
//                            let locationCode = subJson["locationCode"].stringValue
//                            // Get type from pivot dictionary
//                            let locationName = subJson["locationName"].stringValue
//                            let locationCountry = subJson["locationCountry"].stringValue
//                            let locationFlag = subJson["locationFlag"].stringValue
//
//                            self.countryListModel = CountryListModel(locationId: locationId, locationCode: locationCode, locationName: locationName, locationCountry: locationCountry, locationFlag: locationFlag)
//                            self.countryListModelarr.append(self.countryListModel)
//
//                        }
//                        print("total country count after added to model is ",self.countryListModelarr.count)
//
//                    }
//                    else{
